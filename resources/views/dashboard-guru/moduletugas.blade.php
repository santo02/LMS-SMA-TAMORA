        ...
        <div class="main-content">
          ...
          <div class="tab-content" id="myTabContent">
            ...
            >
              ...
              <div>
                <h1 class="week-title">Materi week 2</h1>
                <p>Sesi 1 : <a href="">Kalkulus</a></p>
                <button class="btn-add">+Add Materi</button>
              </div>
              <div>
                <h1 class="week-title">Materi week 3</h1>
                <p>Sesi 1 : <a href="">Gaya</a></p>
                <button class="btn-add">+Add Materi</button>
              </div>
            </div>
            <div
            ...
            >
              ...
              <div>
                <h1 class="week-title">Tugas week 2</h1>
                <p>Sesi 1 : <a href="">Kalkulus</a></p>
                <button class="btn-add">+Add Tugas</button>
              </div>
              <div>
                <h1 class="week-title">Tugas week 3</h1>
                <p>Sesi 1 : <a href="">Gaya</a></p>
                <button class="btn-add">+Add Tugas</button>
              </div>
            </div>
