...
@endsection
@section('content')
    <h1 class="caption">Edit Materi</h1>
    ...
    <div class="box-content container">
        @foreach ($materi as $m)
            <form action="/proses-edit-materi/{{$m->id}}" method="post" enctype="multipart/form-data" class="form-field">
                @csrf
                {{-- @foreach ($id_c as $id) --}}
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="T_mulai" value="{{ $m->T_mulai }}"
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="T_akhir" value="{{ $m->T_akhir }}"
